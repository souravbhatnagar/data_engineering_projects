...
## @type: DataSource
## @args: [database = "db_youtube_raw", table_name = "raw_statistics",
# 		   transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []

predicate_pushdown = "region in ('ca','gb','us')"  # Due to encoding issues
...
## @type: ApplyMapping
## @args: [mapping = [("video_id", "string", "video_id", "string"),
